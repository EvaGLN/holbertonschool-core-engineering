...
## Table of Contents :
  ...
  - [0. Introduction to Inheritance and Polymorphism](#subparagraph0)
  - [1. Base Geometry](#subparagraph1)
  - [2. Rectangle](#subparagraph2)
  - [3. Full Rectangle](#subparagraph3)
  - [4. Square #1](#subparagraph4)
  - [5. Square #2](#subparagraph5)
  - [6. Final Quiz](#subparagraph6)
...
* [Python Documentation – Classes](/rltoken/GqomVH2M0twGjpP955x0CA)
* [Python Documentation – `isinstance()`](/rltoken/ImYJzApMOJyRIHdEjnVk6Q)
* [Python Documentation – `issubclass()`](/rltoken/a-proJGFgiAynj7_oNSclw)
* [Python Tutorial – Class Inheritance](/rltoken/ZBMQBLoQGuXdXFFP-Q8g4g)
* [Real Python – Inheritance and Polymorphism](/rltoken/FKcyhD-1UjFYMyJ0wKWF2Q)
* [Geeks for Geeks – Method Overriding in Python](/rltoken/zioguOx67CHC188Rnh3OVA)

Experimenting with small examples in the Python interpreter can also help clarify how inheritance works.

### Optional Reference

[W3Schools – Python Inheritance](/rltoken/2EQ03QIGnFzW5iYS1r_pug)
...
## Task
### 0. Introduction to Inheritance and Polymorphism <a name='subparagraph0'></a>
...
### 1. Base Geometry <a name='subparagraph1'></a>
...
### 2. Rectangle <a name='subparagraph2'></a>
...
### 3. Full Rectangle <a name='subparagraph3'></a>
...
### 4. Square #1 <a name='subparagraph4'></a>
...
### 5. Square #2 <a name='subparagraph5'></a>
...
### 6. Final Quiz <a name='subparagraph6'></a>

Complete the final quiz to evaluate your understanding of the concepts covered in this project.
