...
## Table of Contents :
  ...
  - [2. The Enigmatic FlyingFish - Exploring Multiple Inheritance](#subparagraph2)
  - [3. The Mystical Dragon - Mastering Mixins](#subparagraph3)
  - [4. Extending the Python List](#subparagraph4)
  - [5. Final Quiz](#subparagraph5)
...
- [Abstract Base Classes](/rltoken/PsGjF-n-V-pVBksLPiHv1A)
- [Python Tutorial — Classes](/rltoken/Cmr2kH1ri4x0usrDEpZ00A)
- [Real Python — Python Interfaces](/rltoken/r6aljYld9Cg1IG0TKWdTLw)
- [Real Python — Mixins and Multiple Inheritance](/rltoken/HcB7mB2RS1vFXURJXeCScw)
- [Geeks for Geeks — Abstract Classes in Python](/rltoken/rOIc14luuZV_B5RLmQrcoQ)
...
### 2. The Enigmatic FlyingFish - Exploring Multiple Inheritance <a name='subparagraph2'></a>
...
### 3. The Mystical Dragon - Mastering Mixins <a name='subparagraph3'></a>
...
### 4. Extending the Python List <a name='subparagraph4'></a>
...
### 5. Final Quiz <a name='subparagraph5'></a>

### Objective

This quiz evaluates your understanding of the main concepts covered in this project.

### Instructions

* The quiz can be taken only once.
* Each question has a time limit.
* Review the checklist below before starting.

### Preparation Checklist

Before starting the quiz, make sure you understand:

* what an abstract class is
* what an abstract method is
* why abstract classes cannot be instantiated
* how subclasses implement abstract behavior
* how duck typing works
* how multiple inheritance works
* what a mixin is
* how mixins compose behavior through small reusable classes
